...
public class RealmClassNamesFileRealmTest {

    @Test
    public void fileRealmItselfTrue() {
        assertTrue(RealmClassNames.isFileRealm(
                "com.sun.enterprise.security.auth.realm.file.FileRealm"));
    }

    @Test
    public void unrelatedFalse() {
        assertFalse(RealmClassNames.isFileRealm("java.lang.String"));
